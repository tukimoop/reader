...
@section('content')
    ...
    <div class="alert alert-info">
        ...
        temporarily removed, they will be added back over the next few days. The current website design is completely temporary and we will be moving to a completely custom design (in a dark theme)
