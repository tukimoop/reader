    ...
    var Plugin = {
        ...
        */
            ...
            if ( li && submenu ) {
                ...
                if ( KUtil.hasClass(li, 'k-menu__item--open') === false ) {
                    ...
                    if ( the.options.accordion.expandAll === false ) {
                        ...
                        var closables = KUtil.children(subnav, '.k-menu__item.k-menu__item--open.k-menu__item--submenu:not(.k-menu__item--expanded):not(.k-menu__item--open-always)');
        ...
        scrollToItem: function(item) {
            ...
            if ( KUtil.isInResponsiveRange('desktop') && the.options.accordion.autoScroll && element.getAttribute('data-kmenu-scrollable') !== '1' ) {
